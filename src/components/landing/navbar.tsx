...
const Navbar = () => {
  const navigation = ["Home", "About Us", "Resources", "Contact Us"];
  const linkUrl = ["#home", "#about_us", "#resources", "#contact"];
    ...
    <div className="w-full">
      <nav className="container relative flex flex-wrap items-center justify-between p-2 mx-auto lg:justify-between xl:px-0">
              ...
              <div className="flex flex-wrap items-center justify-between w-full lg:w-auto">
                ...
                <Disclosure.Panel className="flex flex-wrap w-full my-5 lg:hidden">
                  <>
                    ...
                    <Link
                      to="https://github.com/ElvinEga/organico"
            ...
            {navigation.map((menu, index) => (
              <li className="mr-3 nav__item" key={index}>
                <Link
                  to={linkUrl[index]}
                  // scroll={false}
                  className="inline-block px-4 py-2 text-base font-semibold text-gray-800 no-underline rounded-md dark:text-gray-200 hover:text-green-500 focus:text-green-500 focus:bg-green-100 focus:outline-none dark:focus:bg-gray-800"
                >
                  {menu}
                </Link>
              </li>
        ...
        <div className="hidden mr-3 space-x-4 lg:flex nav__item">
          {/* <ThemeChanger /> */}
          <Link
            to="https://afrijour-dashboard.vercel.app/"
